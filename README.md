...
5.  **Make your changes.**
    - If you add or change a dependency, modify `pyproject.toml` and then run `chmod +x ./scripts/sync-deps.sh && ./scripts/sync-deps.sh` to update the lock file, virtual environment, and production requirements.
